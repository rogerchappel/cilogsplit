...
6. Atomic commits, push to public `rogerchappel/cilogsplit`, branch protection best effort.

## Boundaries

- Work only inside `/Users/roger/Developer/my-opensource/cilogsplit` unless reading shared tools/docs.
